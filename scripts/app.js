    ...
    function createElements(){
        ...
        testStorage.map(SavedCountries => {
            ...
            removeBtn.addEventListener('click', function(){
                ...
                p.remove();
                alert(`Removed ${p.innerText} from your Saved`)
            });
    ...
    if(event.key === 'Enter'){
        ...
        for(let i=0; i < recentArr.length; i++){
            ...
            for(let j = 0; j < recentArr.length; j++){
                if(getFromLocalStorage().includes(recentArr[j])){
            ...
            saveBtn.addEventListener('click', function(e) {
                if(getFromLocalStorage().includes(recentArr[i])){
                    ...
                    alert(`Removed ${recentArr[i]} from your Saved`)
                    ...
                    alert(`Added ${recentArr[i]} to your Saved`);
                }
            });
